...
public class ContactsRecipientsFragment extends Fragment {
  ...
  @Override public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
    ...
    final View rootView =
        inflater.inflate(R.layout.contact_recipient_sample_fragment, container, false);
    ...
    emailRetv.setAdapter(
        new BaseRecipientAdapter(BaseRecipientAdapter.QUERY_TYPE_EMAIL, getActivity()) {
        });
    ...
    final TextView tutorialTextView =
        (TextView) rootView.findViewById(R.id.device_recipients_tutorialTextView);
