...
public class CustomRecipientFragment extends Fragment {
  ...
  @Override public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
    ...
    final View rootView =
        inflater.inflate(R.layout.custom_recipient_sample_fragment, container, false);
    // custom recipients textview sample
    final RecipientEditTextView customRetv =
        (RecipientEditTextView) rootView.findViewById(R.id.custom_retv);
    ...
    final TextView availableRecipientsTextView =
        (TextView) rootView.findViewById(R.id.availableRecipientsTextView);
  ...
  private List<RecipientEntry> generateFakeRecipientsEntries() {
    ...
    for (int i = 0; i < 100; ++i) {
      final RecipientEntry entry =
          RecipientEntry.constructTopLevelEntry("abc" + i, DisplayNameSources.NICKNAME,
              "address" + i, 0, null, i, i, (String) null, true, false);
  ...
  private void removeRandomRecipient(final RecipientEditTextView view) {
    final List<RecipientEntry> recipients =
        new ArrayList<RecipientEntry>(view.getChosenRecipients());
  ...
  private void addRandomRecipient(final RecipientEditTextView view,
      final List<RecipientEntry> allEntries) {
