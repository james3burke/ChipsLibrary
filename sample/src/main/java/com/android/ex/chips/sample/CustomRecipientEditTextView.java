...
public class CustomRecipientEditTextView extends RecipientEditTextView {
  ...
  protected Cursor getCursorForConstruction(final Context context, final long contactId,
      final int queryType) {
    return new AbstractCursor() {
      @Override public boolean isNull(final int column) {
        return false;
      }
      ...
      @Override public short getShort(final int column) {
        return 0;
      }

      @Override public long getLong(final int column) {
        return 0;
      }

      @Override public int getInt(final int column) {
        return 0;
      }

      @Override public float getFloat(final int column) {
        return 0;
      }

      @Override public double getDouble(final int column) {
        return 0;
      }
  ...
  @Override protected ListAdapter createAlternatesAdapter(final DrawableRecipientChip chip) {
