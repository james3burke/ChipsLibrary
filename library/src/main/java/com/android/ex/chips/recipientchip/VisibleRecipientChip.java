...
public class VisibleRecipientChip extends ImageSpan implements DrawableRecipientChip {
  ...
  @Override public CharSequence getDisplay() {
  ...
  @Override public long getContactId() {
    return mDelegate.getContactId();
  }

  @Override public long getDataId() {
    return mDelegate.getDataId();
  }

  @Override public RecipientEntry getEntry() {
    return mDelegate.getEntry();
  }

  @Override public void setOriginalText(final String text) {
    mDelegate.setOriginalText(text);
  }

  @Override public CharSequence getOriginalText() {
    return mDelegate.getOriginalText();
  }

  @Override public boolean isGalContact() {
